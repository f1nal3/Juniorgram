...
* @brief KernelBuilder settings class provider.
...
public:
    ...
    */
    ...
    /**
    * @brief Method to get a kernel port
    * @details It provides a kernel port
    */
    uint16_t getKernelPort() const
    {
        return static_cast<uint16_t>(std::stoul(_settings->getValue(ParamType::KernelPort)));
    }
