...
signals:
    ...
    void onChannelDeleteAnswer(const Utility::DeletingChannelCodes deletingCode);
...
protected:
    ...
    /// Channel Delete Answer handler
    void onChannelDeleteAnswer(const Utility::DeletingChannelCodes deletingState) override;
};
