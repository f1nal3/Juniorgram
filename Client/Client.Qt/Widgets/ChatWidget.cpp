...
void ChatWidget::addMessages(const std::vector<Base::Models::MessageInfo>& messages)
{
...
void ChatWidget::addReplies(const std::vector<Base::Models::ReplyInfo>& replies)
{
