...
#define APPLY_API_METHODS \
            ...
            std::optional<Network::MessageResult> checkServerPing                (std::shared_ptr<Network::Connection> clientConnection,   const Message& message) const override;   \
            ...
            std::optional<Network::MessageResult> directRequestOnConnection  (std::shared_ptr<Network::Connection> client) const override;                                         \
...
namespace Network
{
    class iAPI
    {
         ...
         */
        virtual std::optional<MessageResult> checkServerPing(std::shared_ptr<Connection> client, const Message& message) const = 0;
         ...
         */
        virtual std::optional<MessageResult> directRequestOnConnection(std::shared_ptr<Network::Connection> client) const = 0;
