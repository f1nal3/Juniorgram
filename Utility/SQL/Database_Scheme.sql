...
(
    ...
    token_receipt_time timestamp   NOT NULL
);

CREATE TABLE user_friends_data
(
    user_id   int        NOT NULL,
...
(
    sender_id    int  NOT NULL,
    msg_id_owner int  NOT NULL,
    msg_id_ref   int  NOT NULL,
    msg          text NOT NULL
);
...
ALTER TABLE user_friends_data
    ADD FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE SET NULL;

ALTER TABLE user_friends_data
    ADD FOREIGN KEY (friend_id) REFERENCES users (id) ON DELETE SET NULL;
...
ALTER TABLE channel_images
    ADD FOREIGN KEY (image_id) REFERENCES images (image_id) ON DELETE CASCADE;
...
ALTER TABLE channel_videos
    ADD FOREIGN KEY (video_id) REFERENCES videos (video_id) ON DELETE CASCADE;

ALTER TABLE channel_videos
    ADD FOREIGN KEY (sender_id) REFERENCES users (id) ON DELETE SET NULL;

ALTER TABLE channel_audio
    ADD FOREIGN KEY (channel_id) REFERENCES channels (id) ON DELETE SET NULL;

ALTER TABLE channel_audio
    ADD FOREIGN KEY (audio_id) REFERENCES audio (audio_id) ON DELETE CASCADE;
...
ALTER TABLE channel_links
    ADD FOREIGN KEY (link_id) REFERENCES links (link_id) ON DELETE CASCADE;

ALTER TABLE channel_links
    ADD FOREIGN KEY (sender_id) REFERENCES users (id) ON DELETE SET NULL;

ALTER TABLE channel_replies
    ADD FOREIGN KEY (channel_id) REFERENCES channels (id) ON DELETE CASCADE;

ALTER TABLE channel_replies
    ADD FOREIGN KEY (msg_id_owner) REFERENCES msgs (msg_id) ON DELETE CASCADE;

ALTER TABLE replies
    ADD FOREIGN KEY (msg_id_owner) REFERENCES msgs (msg_id) ON DELETE CASCADE;

ALTER TABLE replies
    ADD FOREIGN KEY (msg_id_ref) REFERENCES msgs (msg_id) ON DELETE CASCADE;
