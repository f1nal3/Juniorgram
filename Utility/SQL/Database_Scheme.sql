...
ALTER TABLE user_channels ADD FOREIGN KEY (channel_id) REFERENCES channels (id) ON DELETE CASCADE;
...
ALTER TABLE channel_files ADD FOREIGN KEY (channel_id) REFERENCES channels (id) ON DELETE CASCADE;
...
ALTER TABLE channel_videos ADD FOREIGN KEY (channel_id) REFERENCES channels (id) ON DELETE CASCADE;
...
ALTER TABLE channel_audio ADD FOREIGN KEY (channel_id) REFERENCES channels (id) ON DELETE CASCADE;
...
ALTER TABLE channel_links ADD FOREIGN KEY (channel_id) REFERENCES channels (id)ON DELETE CASCADE;
