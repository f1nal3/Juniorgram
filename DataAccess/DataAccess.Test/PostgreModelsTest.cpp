...
{
	ModelFactory<PostgreModel> testFactory;

	auto channel = testFactory.create<ChannelData>({
					{ChannelData::CHANNEL_NAME, "boba"},
	...
	auto channelTwo = Models::Channel<PostgreModel>({ { ChannelData::CHANNEL_NAME, "boba" },
													  { ChannelData::CHANNEL_USER_LIMIT, "1000" },
													  { ChannelData::CREATOR_ID, "3" } });
...
//    {
//        User<PostgreModel> testUser({"3", "aboba3@gmail.com", "aboba3", "kindahash3"});
//
...
//
//        Channel<PostgreModel> testChannel({
...
//            {
//                
//                Channel<PostgreModel> testNewChannel({
//                    { ChannelData::CREATOR_ID, "3"},
