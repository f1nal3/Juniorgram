...
namespace DataAccess
{
     ...
     *              of database (subdirectory of executable). Implementation provides no check for names already in use. 
     *              Each table is stored in a subdirectory named after the table. Table directory contains "properties.json" file with 
     *              column type information, and "row_N.json" files store actual data. Database is thread-safe,
